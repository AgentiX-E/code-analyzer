...
- Codex MCP support is evolving — check the Codex documentation for the latest MCP integration details. (No link: the URL this pointed at, and its redirect target, both return 404.)
