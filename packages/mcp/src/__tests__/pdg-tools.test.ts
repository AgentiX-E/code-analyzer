...
function createPDGGraph(store: InMemoryGraphStore, projectId: string): void {
  const nodes: GraphNode[] = [
    // Main function
    {
      ...
      label: 'Function',
      name: 'processRequest',
      qualifiedName: 'app.processRequest',
      filePath: '/app/src/process.ts',
      startLine: 10,
      endLine: 50,
      language: 'typescript',
      properties: {},
    ...
    // Called by processRequest
    {
      ...
      label: 'Function',
      name: 'validateInput',
      qualifiedName: 'app.validateInput',
      filePath: '/app/src/validate.ts',
      startLine: 1,
      endLine: 15,
      language: 'typescript',
      properties: {},
    ...
    // Called by processRequest
    {
      ...
      label: 'Function',
      name: 'sanitizeData',
      qualifiedName: 'app.sanitizeData',
      filePath: '/app/src/sanitize.ts',
      startLine: 1,
      endLine: 20,
      language: 'typescript',
      properties: {},
    ...
    // Sink-like function
    {
      ...
      qualifiedName: 'app.executeSqlQuery',
    ...
    // Source-like function
    {
      ...
      label: 'Function',
      name: 'readUserInput',
      qualifiedName: 'app.readUserInput',
    ...
    // Another function
    {
      ...
      label: 'Function',
      name: 'logResult',
      qualifiedName: 'app.logResult',
      filePath: '/app/src/log.ts',
      startLine: 1,
      endLine: 5,
      language: 'typescript',
      properties: {},
    ...
    // File with user-input in name
    {
      ...
      label: 'Function',
      name: 'handleRequest',
      qualifiedName: 'app.handleRequest',
      filePath: '/app/src/user-input-handler.ts',
      startLine: 1,
      endLine: 30,
      language: 'typescript',
      properties: {},
    ...
    // File with sql-query in file path (for sink matching)
    {
      ...
      label: 'Function',
      name: 'queryDb',
      qualifiedName: 'app.queryDb',
      filePath: '/app/src/sql-query-executor.ts',
      startLine: 1,
      endLine: 10,
      language: 'typescript',
      properties: {},
...
describe('taintAnalysis', () => {
  ...
  it('should detect severity as high for many vulnerable paths', async () => {
    ...
    const source: GraphNode = {
      ...
      label: 'Function',
      name: 'userInput',
      qualifiedName: 'app.userInput',
      filePath: '/app/src/user-input.ts',
      startLine: 1,
      endLine: 5,
      language: 'typescript',
      properties: {},
    ...
    for (let i = 0; i < 6; i++) {
      const sink: GraphNode = {
        ...
        label: 'Function',
        name: `sqlExec${i}`,
        qualifiedName: `app.sqlExec${i}`,
        filePath: '/app/src/sql-query.ts',
        startLine: i * 2,
        endLine: i * 2 + 1,
        language: 'typescript',
        properties: {},
  ...
  it('should return severity medium for some vulnerable paths', async () => {
    ...
    const source: GraphNode = {
      ...
      label: 'Function',
      name: 'readFromEnv',
      qualifiedName: 'app.readFromEnv',
      filePath: '/app/src/environment.ts',
      startLine: 1,
      endLine: 5,
      language: 'typescript',
      properties: {},
    ...
    const sink: GraphNode = {
      ...
      label: 'Function',
      name: 'runCommand',
      qualifiedName: 'app.runCommand',
      filePath: '/app/src/command-exec.ts',
      startLine: 1,
      endLine: 5,
      language: 'typescript',
      properties: {},
