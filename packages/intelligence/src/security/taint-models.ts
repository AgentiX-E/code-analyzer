...
export const TYPESCRIPT_TAINT_MODEL: TaintModel = {
  ...
  sources: [
    ...
    {
      kind: 'remote-input',
      accessType: 'memberRead',
      module: null,
      method: 'req',
      description: 'Express/Koa/Fastify request object',
    },
    {
      kind: 'remote-input',
      accessType: 'memberRead',
      module: null,
      method: 'request',
      description: 'Generic HTTP request object',
    },
    // process.argv
    {
      kind: 'remote-input',
      ...
      module: null,
      method: 'process',
      description: 'process.argv CLI input',
    },
    // fs.readFile (file as source)
    {
      kind: 'file-read',
      accessType: 'callResult',
      module: 'fs',
      method: 'readFile',
      argIndex: 0,
      description: 'File content from fs.readFile',
    },
    {
      kind: 'file-read',
      accessType: 'callResult',
      ...
      method: 'readFileSync',
      argIndex: 0,
      description: 'File content from fs.readFileSync',
    },
    {
      kind: 'file-read',
      accessType: 'callResult',
      ...
      method: 'readFile',
      argIndex: 0,
      description: 'File content from fs/promises.readFile',
    },
    // Network fetch
    {
      kind: 'network-input',
      ...
      module: null,
      method: 'fetch',
      description: 'Response from fetch()',
    },
    {
      kind: 'network-input',
      accessType: 'callResult',
      module: 'axios',
      method: 'get',
      description: 'Response from axios.get',
    },
    {
      kind: 'network-input',
      accessType: 'callResult',
      module: 'axios',
      method: 'post',
      description: 'Response from axios.post',
    },
    // Database
    {
      kind: 'database-input',
  ...
  sinks: [
    // SQL injection
    {
      ...
      cweId: 'CWE-89',
      severity: 'critical',
      matchType: 'anyReceiver',
      module: null,
      method: 'query',
      anyReceiverMethod: 'query',
      taintArg: 0,
    ...
    },
    {
      ...
      module: null,
      method: 'execute',
      anyReceiverMethod: 'execute',
      taintArg: 0,
      description: 'SQL execution with user input',
    },
    {
      kind: 'sql-injection',
      cweId: 'CWE-89',
      severity: 'critical',
      matchType: 'receiverConvention',
      module: null,
      method: 'run',
      receiverPatterns: 'db|database|conn|client|pool|stmt|statement|prepared',
      taintArg: 0,
      description: 'SQL run on DB connection',
    },
    // Command injection
    {
    ...
    // XSS
    {
      ...
      module: null,
      method: 'send',
      receiverPatterns: 'res|response|ctx',
      taintArg: 0,
      description: 'HTTP response with user input',
    },
    {
      kind: 'xss',
      cweId: 'CWE-79',
    ...
    },
    {
      ...
      taintArg: 0,
      description: 'File read stream with user path',
    },
    // Code injection
    {
      kind: 'code-injection',
    ...
    // Deserialization
    {
      ...
      method: 'JSON.parse',
      taintArg: 0,
      description: 'Untrusted JSON deserialization',
    },
  ],
  ...
  sanitizers: [
    ...
    },
    {
      ...
      module: null,
      method: '$$raw',
      description: 'Knex raw value (already escaped)',
    },
    // HTML escaping
    {
      neutralizes: ['xss'],
    ...
    {
      neutralizes: ['xss', 'path-traversal'],
      matchType: 'globalFunction',
      module: null,
    ...
    },
    {
      ...
      module: 'path',
      method: 'resolve',
      description: 'Path resolution (absolute)',
    },
    // Input validation
    {
      neutralizes: ['sql-injection', 'command-injection', 'xss'],
      matchType: 'moduleFunction',
      module: 'validator',
      method: 'escape',
...
export const PYTHON_TAINT_MODEL: TaintModel = {
  ...
  sources: [
    ...
    // FastAPI request
    {
      ...
      module: 'fastapi',
      method: '*',
      description: 'FastAPI request parameter',
    },
    // sys.argv
    {
      kind: 'remote-input',
    ...
    // file reads
    {
      ...
      method: 'open',
      argIndex: 0,
      description: 'File content from open()',
    },
    {
      kind: 'file-read',
      accessType: 'callResult',
    ...
    // Database
    {
      ...
      module: null,
      method: 'cursor',
      description: 'Database cursor result',
    },
  ],
  ...
  sinks: [
    ...
    },
    {
      ...
      module: null,
      method: 'raw',
      receiverPatterns: 'db|database|cursor|conn|connection|session',
      taintArg: 0,
      description: 'Raw SQL on DB handle',
    },
    // Command injection
    {
      kind: 'command-injection',
    ...
    },
    {
      ...
      method: 'call',
      taintArg: 0,
      description: 'Shell via subprocess.call',
    },
    {
      kind: 'command-injection',
      cweId: 'CWE-78',
      ...
      method: 'run',
      taintArg: 0,
      description: 'Shell via subprocess.run',
    },
    // Code injection
    {
      kind: 'code-injection',
  ...
  sanitizers: [
    {
      ...
      description: 'Parameterized cursor.execute',
    },
    {
      neutralizes: ['xss'],
      matchType: 'moduleFunction',
...
export const GO_TAINT_MODEL: TaintModel = {
  ...
  sources: [
    // HTTP request
    {
      ...
      module: 'net/http',
      method: 'Request',
      description: 'HTTP request (*http.Request)',
    },
    {
      kind: 'remote-input',
      accessType: 'callResult',
      module: 'net/http',
      method: 'Request.FormValue',
    ...
    // File read
    {
      ...
      module: 'os',
      method: 'ReadFile',
      description: 'File content from os.ReadFile',
    },
    {
      kind: 'file-read',
      accessType: 'callResult',
      module: 'io/ioutil',
      method: 'ReadFile',
      description: 'File content from ioutil.ReadFile',
    },
    // Network
    {
      kind: 'network-input',
  ...
  sinks: [
    // SQL injection
    {
      ...
      module: 'database/sql',
      method: 'Query',
      receiverPatterns: 'db|database|conn|tx|stmt',
      taintArg: 0,
    ...
    },
    {
      ...
      receiverPatterns: 'db|database|conn|tx|stmt',
      taintArg: 0,
      description: 'SQL exec with user input',
    },
    // Command injection
    {
      kind: 'command-injection',
      ...
      method: 'Command',
      taintArg: 0,
      description: 'Command execution via exec.Command',
    },
    {
      kind: 'command-injection',
      cweId: 'CWE-78',
      ...
      taintArg: 0,
      description: 'Command execution with context',
    },
    // XSS
    {
      kind: 'xss',
      ...
      receiverPatterns: 'w|rw|writer|responseWriter',
      taintArg: 0,
      description: 'HTTP response with user input',
    },
    // Path traversal
    ...
    },
    {
      ...
      method: 'Create',
      taintArg: 0,
      description: 'File create with user path',
    },
    // Code injection
    {
      kind: 'code-injection',
      ...
      method: 'Execute',
      taintArg: 0,
      description: 'Template execution with user data',
    },
    {
      kind: 'code-injection',
      cweId: 'CWE-94',
      ...
      method: 'Execute',
      taintArg: 0,
      description: 'HTML template execution',
    },
  ],
  ...
  sanitizers: [
    {
      ...
      module: 'database/sql',
      method: 'Named',
      description: 'Named parameterized query',
    },
    {
      neutralizes: ['xss'],
      matchType: 'moduleFunction',
    ...
    },
    {
      ...
      module: 'html/template',
      method: 'HTMLEscaper',
      description: 'HTML template auto-escaping',
    },
    {
      neutralizes: ['path-traversal'],
      matchType: 'moduleFunction',
