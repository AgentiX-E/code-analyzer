...
const CHANNEL_RULES: ChannelRule[] = [
  // JS/TS -- Socket.IO
  {
    ...
    receiverPattern: /socket|io|ws|client|server$/,
    methodName: 'emit',
    direction: 'emit',
    transport: 'socketio',
    desc: "socket.emit('event')",
  },
  {
    language: 'js',
    nodeType: 'call_expression',
  ...
  },
  {
    ...
    direction: 'emit',
    transport: 'kafka',
    desc: 'producer.sendBatch()',
  },
  {
    language: 'js',
    nodeType: 'call_expression',
    receiverPattern: /consumer$/,
    methodName: 'subscribe',
    direction: 'listen',
    transport: 'kafka',
    desc: 'consumer.subscribe()',
  },
  {
    language: 'js',
    nodeType: 'call_expression',
  ...
  // Python -- python-socketio / Django Channels
  {
    language: 'py',
    nodeType: 'call',
    receiverPattern: /sio|socketio|socket$/,
    methodName: 'emit',
    direction: 'emit',
    transport: 'socketio',
    desc: "sio.emit('event')",
  ...
  },
  {
    language: 'py',
    nodeType: 'call',
    receiverPattern: /channel_layer$/,
    methodName: 'send',
    direction: 'emit',
    transport: 'django_channels',
    desc: 'channel_layer.send()',
  },
  {
    language: 'py',
    nodeType: 'call',
    receiverPattern: /channel_layer$/,
    methodName: 'group_send',
    direction: 'emit',
    transport: 'django_channels',
    desc: 'channel_layer.group_send()',
  },
  ...
  },
  {
    ...
    nodeType: 'call',
    receiverPattern: /websocket|ws$/,
    methodName: 'receive_text',
    direction: 'listen',
    transport: 'websocket',
    desc: 'ws.receive_text()',
  },
  {
    language: 'py',
    nodeType: 'call',
    receiverPattern: /websocket|ws$/,
    methodName: 'receive_json',
    direction: 'listen',
    transport: 'websocket',
    desc: 'ws.receive_json()',
  },
  ...
  // Go -- gorilla/nhooyr WebSocket
  {
    language: 'go',
    nodeType: 'call_expression',
    receiverPattern: /conn|wsConn|ws|c|Conn|connection$/,
    methodName: 'WriteMessage',
    direction: 'emit',
    transport: 'websocket',
    desc: 'conn.WriteMessage()',
  },
  {
    language: 'go',
    nodeType: 'call_expression',
  ...
  // Java -- Spring STOMP/WebSocket
  {
    ...
    direction: 'emit',
    transport: 'spring_websocket',
    desc: 'template.convertAndSend()',
  },
  {
    language: 'java',
    nodeType: 'method_invocation',
    methodName: 'convertAndSendToUser',
    direction: 'emit',
    transport: 'spring_websocket',
  ...
  },
  {
    ...
    direction: 'emit',
    transport: 'websocket',
    desc: 'session.sendObject()',
  },
  {
    language: 'java',
    nodeType: 'method_invocation',
    methodName: 'sendBinary',
    direction: 'emit',
    transport: 'websocket',
    desc: 'session.sendBinary()',
  },
...
export function detectChannel(
  ...
  const candidates = CHANNEL_RULES.filter(
    (r) => r.language === language && r.methodName === methodName,
  );

  for (const rule of candidates) {
    if (rule.receiverPattern) {
      const tail = receiverText.includes('.')
        ? receiverText.slice(receiverText.lastIndexOf('.') + 1)
        : receiverText;
