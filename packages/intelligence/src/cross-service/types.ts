...
export const METHOD_SUFFIXES: MethodSuffix[] = [
  ...
  { suffix: '.Head', method: 'HEAD' },
  { suffix: '.HEAD', method: 'HEAD' },
  { suffix: '.options', method: 'OPTIONS' },
  { suffix: '.Options', method: 'OPTIONS' },
  { suffix: 'GetAsync', method: 'GET' },
  { suffix: 'PostAsync', method: 'POST' },
  { suffix: 'PutAsync', method: 'PUT' },
  { suffix: 'DeleteAsync', method: 'DELETE' },
  { suffix: 'SendAsync', method: null },
  { suffix: 'getForObject', method: 'GET' },
  { suffix: 'getForEntity', method: 'GET' },
  { suffix: 'postForObject', method: 'POST' },
  { suffix: 'postForEntity', method: 'POST' },
];
...
export const ROUTE_REG_SUFFIXES: MethodSuffix[] = [
  ...
  { suffix: '.HandleFunc', method: 'ANY' },
  { suffix: '.handle', method: 'ANY' },
  { suffix: '.Route', method: 'ANY' },
  { suffix: '.route', method: 'ANY' },
  { suffix: '::get', method: 'GET' },
  { suffix: '::post', method: 'POST' },
  { suffix: '::put', method: 'PUT' },
  { suffix: '::delete', method: 'DELETE' },
  { suffix: '::patch', method: 'PATCH' },
  { suffix: '.MapGet', method: 'GET' },
  { suffix: '.MapPost', method: 'POST' },
  { suffix: '.MapPut', method: 'PUT' },
  { suffix: '.MapDelete', method: 'DELETE' },
  { suffix: '.include_router', method: 'ANY' },
  { suffix: '.mount', method: 'ANY' },
  { suffix: '.add_url_rule', method: 'ANY' },
  { suffix: '.register_blueprint', method: 'ANY' },
  { suffix: '.use', method: 'ANY' },
  { suffix: '.register', method: 'ANY' },
  { suffix: '.add_route', method: 'ANY' },
  { suffix: '.add_api_route', method: 'ANY' },
