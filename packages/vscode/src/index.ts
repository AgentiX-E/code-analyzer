...
// Participant
export { CodeAnalyzerChatParticipant } from './participant/code-analyzer-participant.js';
export type {
  ChatRequest,
  ChatContext,
  ChatResponseStream,
...
export { StatusBarAlignment, DiagnosticSeverity } from './services/vscode-api.js';
...
// Providers
export { SidebarLogic, generateSidebarHtml } from './providers/sidebar-provider.js';
export type { SidebarMessage, SidebarResponse } from './providers/sidebar-provider.js';

export { CommentLogic } from './providers/comment-provider.js';
export type {
  DiagnosticInfo,
  DecorationRange,
  DecoratedDiagnostic,
...
export { ConfigLogic, generateConfigHtml } from './providers/config-provider.js';

export { GraphExplorerLogic } from './providers/graph-explorer.js';
export type { GraphNodeData, GraphEdgeData, GraphData } from './providers/graph-explorer.js';

export { ReviewDecorationLogic } from './providers/review-decoration-provider.js';
export type {
  DecorationSeverity,
  DecorationConfig,
  HoverContent,
...
export { GraphTreeDataProviderLogic } from './providers/tree-view-provider.js';
export type { TreeItemData, GraphTreeItem } from './providers/tree-view-provider.js';

// Views
export { StatusBarManager, createStatusBarManager } from './views/status-bar.js';
export type {
  StatusBarState,
  StatusBarDisplay,
